        ...
        <div className="Projects flex flex-col w-full mt-4 p-4" id="project">
            ...
            <div className="cards flex flex-row gap-4 justify-center w-full px-24 mt-12">
                ...
                <div className="card1 flex flex-col p-2 border-2 border-gray-200 h-[500px] min-w-[400px] rounded-xl hover:shadow-custom hover:-translate-y-4 duration-500">
                    <div className="image w-full h-[250px] rounded-lg overflow-hidden">
                        <img src={careerexpo} alt="projectimg" className="w-full h-full bg-no-repeat bg-center rounded-md hover:scale-105 duration-500"></img>
                    </div>
                ...
                {/* card2 starts */}
                <div className="card flex flex-col p-2 border-2 border-gray-200 h-[500px] min-w-[400px] rounded-xl hover:shadow-custom hover:-translate-y-4 duration-500">
                    <div className="image w-full h-[250px] rounded-lg overflow-hidden">
                        <img src={movieland} alt="projectimg" className="w-full h-full bg-no-repeat bg-center rounded-md hover:scale-105 duration-500"></img>
                    </div>
                    <div className="content flex flex-col mt-2 px-4">
                        <h1 className="projectTitle text-[24px] h-[24px] p-0 mt-4 font-inter font-extrabold text-start">
                            MovieLand
                ...
                <div className="card flex flex-col p-2 border-2 border-gray-200 h-[500px] min-w-[400px] rounded-xl hover:shadow-custom hover:-translate-y-4 duration-500">
                    <div className="image w-full h-[250px] rounded-lg overflow-hidden">
                        <img src={resto} alt="projectimg" className="w-full h-full bg-no-repeat bg-center rounded-md hover:scale-105 duration-500"></img>
                    </div>
                    <div className="content flex flex-col mt-2 px-4">
                        <h1 className="projectTitle text-[24px] h-[24px] p-0 mt-4 font-inter font-extrabold text-start">
                            Resto
